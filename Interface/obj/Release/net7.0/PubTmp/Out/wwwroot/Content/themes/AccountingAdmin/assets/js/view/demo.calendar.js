				...
				****************************** **/
				...
				eventRender: function (event, element, icon) {
					...
					if (!event.icon == '') {
						...
						element.find('.fc-event-title').append("<img src='" + event.icon + "' width='20' height='20' style='margin-top:5px;	border-radius:5px;'  />");
						element.find('.fc-event-title').append("<br /><span class='font300 fsize11' style='font-size: 9px;'>  " + event.startt + ":00 </span><br />");
					}
					if (!event.description == '') {
					
						element.find('.fc-event-title').append("<span class='font300 fsize11' style='font-size: 9px;'>  " + event.description + "</span>" + "<br /><span class='font300 fsize11' style='font-size: 9px;'>  " + event.endd+ ":00 </span>");
					}
					
					

					
				    if (event.today == event.startt) {
				        $('*[data-date=' + event.startt + ']').css({
					...
					$(".fc-event-hori.bg-danger").remove();
					$(".fc-event-vert.bg-danger").remove();
...
/* ========================================== CALENDAR VIEW SWITCHER ========================================= */
	jQuery("a[data-widget=calendar-view]").bind("click", function(e) {
		...
		if(_href) {
			...
			jQuery.cookie('calendar_view', _href, { expires: 30 });
