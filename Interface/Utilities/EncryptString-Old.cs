...
namespace EncryptString
{
    public static class StringCipher
    {
     ...
     //   private const byte[] IV =new byte { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16};
      private const int DerivationIterations = 1000;
       ...
       // https://code-maze.com/csharp-string-encryption-decryption/
        public static  string DecryptAsync(string text, string passphrase)
        {
        ...
        public static  string EncryptAsync(string clearText, string passphrase)
        {
             Aes aes = Aes.Create();
            aes.Key = DeriveKeyFromPassword(passphrase);
            var IV = new byte[] { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16 };
